...
PropType = Propulsion_Input.PropType{Config_Row}; %Must be 'PROP_Fuel', 'JET_LBP_Turbofan','JET_HBP_Turbofan'
...
if strcmp(PropType,'PROP_Fuel')
    P_lapse = (rho_alt/rho_sl)*PropEff; %Corrects for altitude and propellor efficiency
